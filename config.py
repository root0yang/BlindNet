...
__C.DATASET.CITYSCAPES_DIR = '/data3/yang/datasets/cityscapes'
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = '/data3/yang/datasets/mapillary'
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = '/data3/yang/datasets/gtav'
__C.DATASET.BDD_DIR = '/data3/yang/datasets/bdd-100k'
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = '/data3/yang/datasets/synthia'
